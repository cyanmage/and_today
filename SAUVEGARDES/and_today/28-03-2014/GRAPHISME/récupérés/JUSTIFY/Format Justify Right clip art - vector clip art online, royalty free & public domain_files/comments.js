...
function showbox(divtag, thingid, commentid, type, onuser)
{
  var tag="ta"+divtag;
  var box="";
  if (type=='commentflag') box+="<b>You are reporting a comment for violation. Please identify your reason(s):</b>";
  if (type=='thingflag') box+="<b>You are reporting a picture for violation. Please identify your reason(s):</b>";
