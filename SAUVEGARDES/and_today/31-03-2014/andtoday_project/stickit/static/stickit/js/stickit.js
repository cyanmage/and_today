...
//console.log(element.attr('id_cadre'), "???");
				if (id_cadre){
					scope.sauveSurServeur = true;

					element
						.draggable({containment : parent, 	cursor : 'move', 		disabled : true})
						.resizable({containment : parent,   handlers : "e, s, se",	disabled : true});	
				}	
				else{
			...
			element.droppable({
				...
				drop : function(event, ui){
					...
					if (ui.helper.hasClass("helperCreationSticker")){
						...
						var cadre = $("div#motif-cadre .cadre").clone();	//					
