...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_post', (
            ...
            ('date_creation', self.gf('django.db.models.fields.DateField')(blank=True, auto_now_add=True, default=datetime.datetime(2013, 12, 10, 0, 0))),
        ))
    ...
    models = {
        ...
        'core.post': {
            ...
            'date_creation': ('django.db.models.fields.DateField', [], {'blank': 'True', 'auto_now_add': 'True', 'default': 'datetime.datetime(2013, 12, 10, 0, 0)'}),
